"""
dlg_mwa_solar component module.

This is the module of dlg_mwa_solar containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/dlg_mwa_solar.MyData/String/readonly/
